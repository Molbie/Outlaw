...
public extension Extractable {
    ...
    func optional<V: ValueWithContext>(for key: Key, using context: V.Context) -> V? {
    ...
    func value<V: ValueWithContext>(for key: Key, using context: V.Context, or value: V) -> V {
        guard let result: V = self.optional(for: key, using: context) else { return value }
        return result
    }
}
...
public extension Extractable {
    ...
    func optional<K, V: ValueWithContext>(for key: Key, using context: V.Context) -> [K: V]? {
        return try? self.value(for: key, using: context)
    }
    
    func value<K, V: ValueWithContext>(for key: Key, using context: V.Context, or value: [K: V]) -> [K: V] {
        guard let result: [K: V] = self.optional(for: key, using: context) else { return value }
        return result
    }
}
...
public extension Extractable {
    ...
    func optional<V: ValueWithContext>(for key: Key, using context: V.Context) -> Set<V>? {
        return try? self.value(for: key, using: context)
    }
    
    func value<V: ValueWithContext>(for key: Key, using context: V.Context, or value: Set<V>) -> Set<V> {
        guard let result: Set<V> = self.optional(for: key, using: context) else { return value }
        return result
    }
}
