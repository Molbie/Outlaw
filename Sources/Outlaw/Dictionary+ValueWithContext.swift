...
public extension Dictionary {
    public static func mappedValue<Value: Outlaw.ValueWithContext>(from object: Any, using context: Value.Context) throws -> [Key: Value] {
...
public extension Dictionary {
    public static func mappedValue<Value: Outlaw.ValueWithContext, T>(from object: Any, using context: Value.Context, with transform:(Value, Value.Context) throws -> T) throws -> [Key: T] {
        guard let anyDictionary = object as? [Key: Any] else {
            throw OutlawError.typeMismatch(expected: self, actual: type(of: object))
        }
    ...
    public static func mappedValue<Value: Outlaw.ValueWithContext, T>(from object: Any, using context: Value.Context, with transform:(Value, Value.Context) -> T?) throws -> [Key: T?] {
        guard let anyDictionary = object as? [Key: Any?] else {
            throw OutlawError.typeMismatch(expected: self, actual: type(of: object))
        }
